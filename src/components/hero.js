...
export default () => {
  ...
  return (
    <React.Fragment>
      <div
        className="hidden lg:block absolute rounded-full bg-gradient-1"
        style={{ height: 180, width: 180, top: 210, left: -90 }}
      />
      <div
        className="hidden lg:block absolute rounded-full bg-gradient-2"
        style={{ height: 35, width: 35, top: 150, left: 25 }}
      />
      <div
        className="hidden lg:block absolute rounded-full bg-gradient-3"
        style={{ height: 190, width: 190, bottom: 80, right: 120 }}
      />
      <div
        className="hidden lg:block absolute rounded-full bg-gradient-4"
        style={{ height: 90, width: 90, bottom: 80, left: 40 }}
      />
      <div
        className="hidden lg:block absolute rounded-full bg-donut-1"
